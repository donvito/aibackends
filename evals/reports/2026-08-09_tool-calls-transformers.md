...
Runtime `transformers`, model `lfm2.5-2.6b`, device `cpu`, max_tokens 1024. One completion per case; predicted calls parsed with `aibackends.core.tool_calls.extract_tool_calls`.

## Environment

- Date: 2026-08-09 07:20:25 UTC
...
| Mean latency per case | 33,908 ms |
